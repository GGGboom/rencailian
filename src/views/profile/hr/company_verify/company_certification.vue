<template>
    <div v-loading="loading">
        <div class="info-list" v-if="isVerify">
            <div class="info-item">
                <div class="item-left">
                    <span class="emphase">公司信息</span>
                </div>
            </div>
            <div class="info-item">
                <div class="item-left">
            ...
            <div class="contract-btn">
                <div class="btn-box">
                    <el-button type="primary">编辑公司地址</el-button>
                </div>
            </div>
        </div>
...
<style scoped>
    ...
    .info-list .contract-content{
        padding: 20px 0;
        display: block;
        font-size: 16px;
        border-bottom: 1px solid #e1e4e8;
    }
    .info-list .contract-content .ct-content{
        padding: 10px 0;
    }

    .info-list .contract-btn{
        display: flex;
