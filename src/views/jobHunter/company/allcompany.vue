<template>
    <div class="company-search home-site">
        ...
        <div class="company-tab-box company-list">
            <ul>
                <li>
                    <router-link to="/company/detail" class="company-info">
                        <img :src="url" alt>
    ...
    export default {
        ...
        methods: {
            get(){
                ...
                //     positionType:[1187]
                // }
                // this.$post(`/companys/classify?pageSize=20&pageNum=1&authorization=${CommonUtils.getStore("token")}`,data)
                //     .then(res=>{
                //         if(res.code===0){
